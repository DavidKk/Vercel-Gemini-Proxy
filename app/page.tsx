          ...
          <div className="relative z-10 mx-auto flex min-h-[100dvh] w-full max-w-6xl items-center px-6 py-20 lg:py-24">
            <div className="max-w-xl lg:max-w-[28rem] xl:max-w-xl">
              <div className="home-animate-1 flex items-center gap-3">
                <Link href="/" aria-label="Home" className="rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand">
          ...
          <div className="mx-auto grid w-full max-w-6xl gap-14 px-6 py-16 lg:grid-cols-2 lg:gap-20 lg:py-20">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted">
                Paths under <code className="text-primary">/api/v1</code>, <code className="text-primary">/api/v1beta</code>, <code className="text-primary">/api/v1beta2</code>.
              </p>

              <h3 className="font-display mt-6 text-sm font-semibold text-primary">Passthrough</h3>
              <p className="mt-1 text-sm text-muted">
                Caller sends a Gemini key via <code className="text-primary">?key=</code> or <code className="text-primary">x-goog-api-key</code>.
              </p>
              <CodeBlock tone="canvas" label="curl">{`curl "$HOST/api/v1beta/models?key=$GEMINI_API_TOKEN"`}</CodeBlock>
              ...
              <p className="mt-6 text-sm text-muted">
                Deploy your own instance and set env vars — see the{' '}
                <Link href="/docs/pass-key" className="font-medium text-brand hover:text-brand-hover">
                  full API guide
                </Link>
                .
              </p>
