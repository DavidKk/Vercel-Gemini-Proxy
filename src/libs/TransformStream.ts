...
import type { QueuingStrategy, Transformer, TransformStreamDefaultController } from 'stream/web'
import { ReadableStream as WebReadableStream, TransformStream as WebTransformStream, WritableStream as WebWritableStream } from 'stream/web'
...
export { ExchangeReadableStream as ReadableStream, ExchangeTransformStream as TransformStream, ExchangeWritableStream as WritableStream }
...
export type { QueuingStrategy, Transformer, TransformStreamDefaultController, WebReadableStream, WebTransformStream, WebWritableStream }
